...
img_enemy2 = "zombie2.png" 
img_ast = "car.png" 
img_bullet2 = "bulet2.png" 
img_bullet3 = "bulet3.png"
...
for i in range(1, 6):
    monster = Enemy(img_enemy, randint(80, win_width - 80), -40, 120, 120, randint(1, 3))
    monsters.add(monster)

for i in range(1, 6):
    monster2 = Enemy(img_enemy2, randint(80, win_width - 80), -40, 100, 100, randint(1, 2))
